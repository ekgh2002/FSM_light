...
HD_PWD='D:/KIMGYUHAN/project/FPGA/FSM_Light/FSM_Light.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ledlight.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ledlight.tcl
