...
HD_PWD='D:/KIMGYUHAN/project/FPGA/FSM_Light/FSM_Light.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ledlight.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ledlight.tcl -notrace
